...
function Checkout() {
  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
      ...
      <form className='bg-white p-4 mt-12'>
    ...
    <h2 class="text-base font-semibold leading-7 text-gray-900">Address</h2>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-100">
        ...
        <fieldset>
          ...
          <p class="mt-1 text-sm leading-6 text-gray-600">Choose One payment method</p>
...
<div className="mx-auto mt-12 max-w-7xl bg-white px-0 sm:px-0 lg:px-0">
    <h1 className="text-4xl font-bold tracking-tight text-gray-900">Cart</h1>
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
              ...
              Qty
            </label><select><option value="1"></option>
